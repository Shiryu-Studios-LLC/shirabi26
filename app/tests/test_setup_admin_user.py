...
def _load_setup_module():
    ...
    spec = importlib.util.spec_from_file_location("shirabe_setup_under_test", setup_path)
...
def test_create_default_admin_normalizes_env_username(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("SHIRABE_ADMIN_USER", " AdminUser ")
    monkeypatch.setenv("SHIRABE_ADMIN_PASSWORD", "temporary-password")
