"""scripts/_lib/cli.py — shared scaffolding for the `shirabe-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("shirabe-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/shirabe-foo`
...
VERSION = "0.1.0"  # bumped centrally; every shirabe-* CLI reports this
