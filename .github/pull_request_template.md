...
- [ ] I searched [open issues](https://github.com/pewdiepie-archdaemon/shirabe/issues) and [open PRs](https://github.com/pewdiepie-archdaemon/shirabe/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Shirabe's existing visual language. Specifically:
